						...
						<div class="row">
							<div class="col-xs-12">
								...
								<div class="row">
									...
									<form action="index.php?r=manager/update" method="post" id="loginForm">
											...
											<input type="hidden"  name='u_id' value="<?= $info['id']?>">
												<thead>
													<tr>
														...
														<th>
															<input type="text"   placeholder="请输入名称" name='u_name' value="<?= $info['u_name']?>"> <font  style="padding-right:320px;"></font>
														</th>
												...
												<thead>
													<tr>
														<th class="hidden-480" style="padding-left:480px;">设置新密码：</th>

														<th>
															
															<input type="password" placeholder="设置新密码" name='u_pwd'>
														</th>
													</tr>
												</thead>
