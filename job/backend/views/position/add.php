						...
						<div class="row">
							<div class="col-xs-12">
								...
								<div class="row">
									...
									<form action="index.php?r=position/add" method="post" id="loginForm">
											...
											<table id="sample-table-1" class="table table-striped table-bordered table-hover"> 
												<thead>
													<tr>
														...
														<th>
															<input type="text" id="position_name" name="position_name" maxlength="20" value="" size="27" class="icon-time bigger-110 hidden-480" placeholder="请输入职位"> <font  style="padding-right:320px;"></font>
														</th>
													...
													<tr>
														...
														<th>
															...
															<?php foreach ($data as $key => $val) { ?>
																<option value="<?=$val['id']?>"><?= $val['html'],$val['position_name'] ?></option>
															<?php } ?>    
															</select>
														</th>
													</tr>
												...
												<thead>
													<tr>
														<td class="hidden-480;" style="padding-left:505px;"><input type="submit" value=" 确定 " class="icon-time bigger-110 hidden-480 btn btn-xs btn-success" ></td>
