    ...
    <div id="container">
        ...
        <div class="content_mid">
        	<dl class="c_section c_section_mid">
                ...
                <dd>
	                <form method="post" action="?r=company/addone" enctype="multipart/form-data">
	                	<div class="c_text_1">基本信息为必填项，是求职者加速了解公司的窗口，认真填写吧！</div>

						<center><h1 style="color:seagreen">※&nbsp;&nbsp;&nbsp;&nbsp;基本信息（必填）</h1></center>
	                    
	                    <h3>公司全称</h3>
						<input type="text" name="comp_name" placeholder="请填写公司全称">
	                    
	                    <h3>公司简称</h3> <!--非必填-->
	                    <input type="text" placeholder="请输入公司简称，如:拉勾" value="" name="comp_abb" id="name" class="valid">
	                    ...
	                    <h3>公司网址</h3>
	                    <input type="text" placeholder="请输入公司网址" value="" name="comp_url" id="website">
	                    
	                    <h3>所在城市</h3>
	                    <input type="text" placeholder="请输入工作城市，如：北京" name="comp_city" id="city">
	                    
	                    <h3>行业领域</h3>
	                    <div>
		                    <input type="hidden" value="" name="select_industry_hidden" id="select_industry_hidden">
		                    		                    	<input type="button" name="industry_sector" id="select_industry" class="select" placeholder="请选择行业领域" >
	                    ...
	                    <div>
		                    ...
		                    <input type="button"  placeholder="请选择公司规模"  id="select_scale" class="select" name="comp_scale">
	                    ...
	                    <h3>发展阶段</h3> 
	                    <div>
		                    <input type="hidden" id="s_radio_hidden" name="comp_stage" value="">
	                    ...
	                    <h3>公司介绍</h3>
						<textarea name="comp_self" id="" cols="30" rows="10"></textarea>
