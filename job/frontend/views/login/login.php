...
<body id="login_bg">
	<div class="login_wrapper">
    	...
    	<input type="hidden" id="resubmitToken" value="" />		
		 <div class="login_box">
        	<form id="loginForm" action="?r=login/log" method="post">
...
<script type="text/javascript" src="http://open.51094.com/user/myscript/157de0a8613adf.html"></script>
<script type="text/javascript">
$(function(){
	//验证表单
	 	$("#loginForm").validate({
