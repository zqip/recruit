...
<div id="body">
    ...
    <dl id="user_sideBarmenu" class="user_sideBarmenu">
                <dt><h3>帐号设置</h3></dt>
                <dd><a  href="?r=personal/accountbind">个人信息</a></dd>
        <dd><a class="hover" href="?r=personal/updatepwd">修改密码</a></dd>
            </dl>
</div>
<input type="hidden" id="hasSidebar" value="1">	<div class="content user_modifyContent">
        <dl class="c_section">
            ...
            <dd>
            	<form id="updatePswForm" action="index.php?r=personal/updatepwd" method="post" >
                <input type="hidden" method='post' name="_csrf" id="_csrf" value="<?= Yii::$app->request->csrfToken ?>">
            		<table class="savePassword">
            			...
            			<tr>
            				...
            				<td>
            					<input id="pwd" type="password" maxlength="16" id="password" name="password" style="background-image: url(style/images/img/0CQnd2Jos49xUAAAAASUVORK5CYII=quot); background-repeat: no-repeat; background-attachment: scroll; background-position: right center;">
            					<span id="updatePwd_beError" style="display:none;" class="error"></span><br><span id='ppd'></span></td>            				
            			</tr>
            			<tr>
...
<script src="style/js/core.min.js" type="text/javascript">
