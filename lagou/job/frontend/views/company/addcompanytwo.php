        ...
        <div class="content_mid">
            <dl class="c_section c_section_mid">
                ...
                <dd>
					...
					<center><h1 style="color:seagreen">※&nbsp;&nbsp;&nbsp;&nbsp;创始团队（必填）</h1></center>
                    
                    <form method="post" action="?r=company/addtwo" enctype="multipart/form-data">
		                    ...
		                    <div class="formWrapper">
		                    	<!--<input type="hidden" value="25927" name="leaderInfos[0].companyId">-->
		                         ...
		                         <div class="new_portrait">
			                        ...
			                        <!--<input type="file" value="" title="支持jpg、jpeg、gif、png格式，文件小于5M" onchange="img_check(this,'http://www.lagou.com/c/upload.json',120,120,5,'myfiles0','myfiles0_error','portraitNo0','portraitShow0','type0','leaderInfos0');" name="myfile" id="myfiles0" class="myfiles">-->
		                        ...
		                        <h3>创始人姓名</h3>
		                        <input type="text" placeholder="请输入创始人姓名" name="originator" id="name0" class="s_input1 valid">
		                        
		                        <h3>当前职位</h3>
		                        <input type="text" placeholder="请输入当前职位，如：创始人兼CEO" name="ori_pos" id="position0" class="s_input1 valid">
		                        
		                        <h3>新浪微博</h3>
		                        <input type="text" placeholder="请输入创始人新浪微博地址" name="ori_sina" id="weibo0">
		                        
		                        <h3>创始人简介</h3> 
		                        <textarea placeholder="请输入该创始人的个人履历等，建议按照时间倒序分条展示" maxlength="1000" name="ori_self" id="description0"></textarea>
