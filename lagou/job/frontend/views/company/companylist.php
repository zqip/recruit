	                    ...
	                    <dd>
	                        ...
	                        <!-- <dl>
	                            ...
	                            <dd>
	               	                	...
	               	                	<?php $i=0; foreach ($comList as $key => $val) { $i++;
	               	                		if( $i%4 == 0){ ?>
		                  		                  		                        <li  style="clear:both;" >
		                  		             <?php }
		                  		             else{ ?>
			                        ...
			                        <a href="h/c/25829.html" target="_blank">
			                        	<h3 title="<?=$val['comp_abb']?>"><?=$val['comp_abb']?></h3>
			                        	<div class="comLogo">
				                        	<img src="company_logo/<?=$val['comp_logo']?>" width="190" height="190" alt="CCIC" />
				                        	<ul>
				                        		<li>安全</li>
				                        		<li><?=$val['comp_city']?>,<?=$val['comp_stage']?></li>
				                        	</ul>
			                        	</div>
			                        </a><?php 
			                        					$tempt_list = array();
			                        foreach ($val['invite'] as $k => $v) { ?>
			                        			                        	<a href="h/jobs/148928.html" target="_blank"><?=$v['position_name']?></a>
			                       <?php } ?>
			                        			                     
			                        			                        <ul class="reset ctags">
			                        				                 <li><?=$val['comp_stage']?></li>
			                        				<?php foreach ($val['invite'] as $k => $v) { 
			                        							$jobtempt = explode('、', $v['jobtempt']);
			                        							foreach ($jobtempt as $job_key => $job_val) {  
			                        								if(!in_array($job_val, $tempt_list))
			                        								{
			                        									$tempt_list[]  = $job_val;
			                        								}
			                        							}

			                      					} 	foreach ($tempt_list as $t_key => $t_value) {
			                        							   ?>
