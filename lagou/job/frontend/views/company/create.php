            ...
            <div class="content">
            	<dl class="company_center_content">
                    ...
                    <dd>
                    	...
                    	<form action="?r=company/create" method="post" id="jobForm">
                    	<input name="_csrf" type="hidden" id="_csrf" value="<?= Yii::$app->request->csrfToken ?>">
                            ...
                            <table class="btm">
                            	<tbody><tr>
                                	...
                                	<td width="85">职位类别</td>
                                	<td>
                                    	<input type="hidden" id="positionType" value="" name="position_type">
                                        ...
                                        <?php foreach($position as $v){ ?>
                                            <dl>
                                              <dt><?php echo $v['position_name']; ?></dt>
                                                <dd>
                                                    <ul class="reset job_main">
                                                    <?php foreach($v['son'] as $va){ ?>
                                                        <li>
                                                            <span><?php echo $va['position_name']; ?></span>
                                                            <ul class="reset job_sub dn"> 
															<?php foreach($va['grandson'] as $val){ ?>
															<li><?php echo $val['position_name']; ?></li>
															<?php } ?>                          
                                                            </ul>
                                                        </li>  
                                                    <?php } ?>                                
                            	...
                            	<tr>
                                	...
                                	<td>职位名称</td>
                                	<td>
                                    	<input type="text" placeholder="请输入职位名称，如：产品经理" value="" name="position_name" id="position_name">
                                    	                                    </td>
                                </tr>
                            	<tr>
                                	<td></td>
                                	<td>所属部门</td>
                                	<td>
                                    	<input type="text" placeholder="请输入所属部门" value="" name="office" id="department">	
                                    </td>
                                </tr>
                            </tbody></table>
                            ...
                            <table class="btm">
                            	...
                            	<tr>
                                	...
                                	<td>
                                    	<div class="salary_range">
                                            <div>
                                                <input type="text" placeholder="最低月薪" value="" id="salaryMin" name="money_start"> 
                                                <span>k</span>
                                            </div>
                                            <div>
                                                <input type="text" placeholder="最高月薪" value="" id="salaryMax" name="money_end"> 
                                                <span>k</span>
                                            </div>
                            	...
                            	<tr>
                                	...
                                	<td>工作城市</td>
                                	<td>
                                    	<input type="text" placeholder="请输入工作城市，如：北京" value="" name="region" id="workAddress">
                                    </td>
                                </tr>
                            </tbody></table>
                            ...
                            <table class="btm">
                            	<tbody><tr>
                                	...
                                	<td width="85">工作经验</td>
                                	<td>
                                    	<input type="hidden" id="experience" value="" name="jobexp">
                            	...
                            	<tr>
                                    ...
                                    <!--<h3><span>(最高月薪不能大于最低月薪的2倍)</span></h3> -->
                                	<td>
                                    	<input type="hidden" id="education" value="" name="jobedu">
                            ...
                            <table class="btm">
                            	<tbody><tr>
                                	...
                                	<td width="85">职位诱惑</td>
                                	<td>
                                    	<input type="text" placeholder="20字描述该职位的吸引力，如：福利待遇、发展前景等" value="" name="jobtempt" class="input_520" id="positionAdvantage">
                                    </td>
                                </tr>
                            	<tr>
                                	<td><span class="redstar">*</span></td>
                                ...
                                <tr>
                                	...
                                	<td>工作地址</td>
                                	<td>
                                    	<input type="text" placeholder="请输入详细的工作地址" value="" name="jobaddress" class="input_520" id="positionAddress">	
                            ...
                            <table>
                                ...
                                <tr>
                                	...
                                	<td colspan="2">
                                    	同时简历自动发送至邮箱（仅一个）
                                        <input type="text" value="" id="forwardEmail" name="resume_email">
