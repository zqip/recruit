...
<dl class="hotSearch">
	<dt>热门搜索：</dt>
		<?php foreach($hot as $v){ ?>
			<dd><a href="?r=index/selpos&kd=<?php echo $v['position_name']; ?>"><?php echo $v['position_name']; ?></a></dd>
		<?php } ?>
</dl>			
		    ...
		    <dl>
			   <!--  <dt>请选择城市</dt> -->
				...
				<?php foreach($city as $v){ ?>
			        <a href="#"><?php echo $v['region_name']; ?></a>
			    <?php } ?>
			    </dd>
			</dl>
			</dd>  
            ...
            <?php if(isset($msg)){ echo $msg; }else{ ?>         
            	...
            	<?php foreach($pos as $v){ ?>
	                <li class="odd clearfix">
			            <div class="hot_pos_l">
			                <div class="mb10">
			                    <a href="h/jobs/86989.html" title="<?php echo $v['position_type']; ?>" target="_blank"><?php echo $v['position_type']; ?></a> 
			                            &nbsp;
			                    <span class="c9">[<?php echo $v['region']; ?>]</span>
			                </div>
			                        <span><em class="c7">月薪：</em><?php echo $v['money_start']; ?>k-<?php echo $v['money_end']; ?>k</span>
			                        <span><em class="c7">经验：</em><?php echo $v['jobexp']; ?></span>
			                        <span><em class="c7">最低学历： </em><?php echo $v['jobedu']; ?></span>
			                        <br />
			                        <span><em class="c7">职位诱惑：</em><?php echo $v['jobtempt']; ?></span>
			                        <br />
			                        <span>1天前发布</span>
			            </div> 
						        <div class="hot_pos_r">
			                        ...
			                        <div class="mb10"><a href="h/c/1712.html" title="<?php echo $v['comp_name']; ?>" target="_blank"><?php echo $v['comp_name']; ?></a></div>
			                        <span><em class="c7">领域： </em><?php echo $v['industry_sector']; ?></span>
			                        			                        <span><em class="c7">创始人：</em><?php echo $v['originator']; ?></span>
			                        			                        <br />
			                        <span><em class="c7">阶段： </em><?php echo $v['comp_stage']; ?></span>
			                        <span><em class="c7">规模： </em><?php echo $v['comp_scale']; ?></span>
